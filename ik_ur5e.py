...
def inverse_kinematics_ur5e(ae_1, ae_2, ae_3, se_1, se_2, se_3, p_x, p_y, p_z):
	...
	K_0[4] = (-S_c[4]) # einf
	C_5k = np.zeros(32)
	C_5k[8] = P_5[1] * K_0[4] # e1 ^ einf
	C_5k[11] = P_5[2] * K_0[4] # e2 ^ einf
	C_5k[15] = S_c[4] + (-K_0[4]) # einf ^ e0
	Q_c = np.zeros(32)
	Q_c[21] = P_5[1] * P_5[3] # e1 ^ (einf ^ e0)
	Q_c[24] = P_5[2] * P_5[3] # e2 ^ (einf ^ e0)
	...
	macro_ExtractFirstPoint_dPP[12] = (-P_5[1]) # e2 ^ e0
	P_c = np.zeros(32)
	P_c[1] = math.sqrt(abs(C_5k[8] * P_5[1] + P_5[1] * C_5k[8] + Q_c[21] * Q_c[21] + C_5k[11] * P_5[2] + P_5[2] * C_5k[11] + Q_c[24] * Q_c[24] + Q_c[25] * Q_c[25])) * P_5[2] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]) + macro_ExtractFirstPoint_dPP[6] * macro_ExtractFirstPoint_dPP[12] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]) # e1
	P_c[2] = math.sqrt(abs(C_5k[8] * P_5[1] + P_5[1] * C_5k[8] + Q_c[21] * Q_c[21] + C_5k[11] * P_5[2] + P_5[2] * C_5k[11] + Q_c[24] * Q_c[24] + Q_c[25] * Q_c[25])) * macro_ExtractFirstPoint_dPP[12] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]) + (-(macro_ExtractFirstPoint_dPP[6] * P_5[2] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]))) # e2
	P_c[3] = (-(Q_c[24] * P_5[2] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]))) + (-(macro_ExtractFirstPoint_dPP[10] * macro_ExtractFirstPoint_dPP[12] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]))) # e3
	P_c[4] = (-(macro_ExtractFirstPoint_dPP[8] * P_5[2] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]))) + (-(C_5k[8] * macro_ExtractFirstPoint_dPP[12] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]))) # einf
	P_c[5] = (-(P_5[2] * P_5[2] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]))) + (-(macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]))) # e0
	P_c[16] = (-(Q_c[24] * macro_ExtractFirstPoint_dPP[12] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]))) + macro_ExtractFirstPoint_dPP[10] * P_5[2] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]) # e1 ^ (e2 ^ e3)
	P_c[17] = (-(macro_ExtractFirstPoint_dPP[8] * macro_ExtractFirstPoint_dPP[12] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]))) + C_5k[8] * P_5[2] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]) # e1 ^ (e2 ^ einf)
	P_c[18] = (-(P_5[2] * macro_ExtractFirstPoint_dPP[12] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]))) + macro_ExtractFirstPoint_dPP[12] * P_5[2] / (P_5[2] * P_5[2] + macro_ExtractFirstPoint_dPP[12] * macro_ExtractFirstPoint_dPP[12]) # e1 ^ (e2 ^ e0)
	PI_c = np.zeros(32)
	PI_c[1] = (-P_c[2]) # e1
	PI_c_parallel = np.zeros(32)
	PI_c_parallel[4] = P_5[1] * PI_c[1] + P_5[2] * P_c[1] # einf
	PI_56_orthogonal = np.zeros(32)
	PI_56_orthogonal[1] = P_5[1] + (-p_x) # e1
	PI_56_orthogonal[2] = P_5[2] + (-p_y) # e2
	...
	Q_4 = np.zeros(32)
	Q_4[16] = (-((-(L_45[6] * (-P_5[3]))) + (-(L_45[7] * P_5[2])) + (-(L_45[10] * (-P_5[1]))))) # e1 ^ (e2 ^ e3)
	Q_4[17] = (-(L_45[6] * S_5[4])) + L_45[8] * P_5[2] + L_45[11] * (-P_5[1]) # e1 ^ (e2 ^ einf)
	Q_4[18] = (-L_45[6]) # e1 ^ (e2 ^ e0)
	Q_4[19] = (-(L_45[7] * S_5[4] + L_45[8] * (-P_5[3]) + (-(L_45[13] * (-P_5[1]))))) # e1 ^ (e3 ^ einf)
	Q_4[20] = (-L_45[7]) # e1 ^ (e3 ^ e0)
	Q_4[21] = (-L_45[8]) # e1 ^ (einf ^ e0)
	Q_4[22] = (-(L_45[10] * S_5[4])) + (-(L_45[11] * (-P_5[3]))) + (-(L_45[13] * P_5[2])) # e2 ^ (e3 ^ einf)
	...
	b_5[3] = (-ae_3) # e3
	x5 = np.zeros(32)
	x5[0] = (-((P_c[1] * b_5[2] + (-(P_c[2] * b_5[1]))) * (-L_45[6]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-((P_c[1] * b_5[3] + (-(P_c[3] * b_5[1]))) * (-L_45[7]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[5] * b_5[1])) * (-L_45[8]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((P_c[2] * b_5[3] + (-(P_c[3] * b_5[2]))) * (-L_45[10]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[5] * b_5[2])) * (-L_45[11]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-(P_c[5] * b_5[3])) * (-L_45[13]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) # 1.0
	x5[6] = (-((P_c[1] * b_5[3] + (-(P_c[3] * b_5[1]))) * (-L_45[10]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[5] * b_5[1])) * (-L_45[11]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (P_c[2] * b_5[3] + (-(P_c[3] * b_5[2]))) * (-L_45[7]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((-(P_c[5] * b_5[2])) * (-L_45[8]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[18] * b_5[3])) * (-L_45[13]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) # e1 ^ e2
	x5[7] = (P_c[1] * b_5[2] + (-(P_c[2] * b_5[1]))) * (-L_45[10]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-(P_c[5] * b_5[1])) * (-L_45[13]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((P_c[2] * b_5[3] + (-(P_c[3] * b_5[2]))) * (-L_45[6]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-((-(P_c[5] * b_5[3])) * (-L_45[8]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-((-(P_c[18] * b_5[3])) * (-L_45[11]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) # e1 ^ e3
	x5[8] = (P_c[1] * b_5[2] + (-(P_c[2] * b_5[1]))) * (-L_45[11]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (P_c[1] * b_5[3] + (-(P_c[3] * b_5[1]))) * (-L_45[13]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((-(P_c[4] * b_5[2])) * (-L_45[6]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-((-(P_c[4] * b_5[3])) * (-L_45[7]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-((-(P_c[17] * b_5[3])) * (-L_45[10]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) # e1 ^ einf
	x5[9] = (-((-(P_c[5] * b_5[2])) * (-L_45[6]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-((-(P_c[5] * b_5[3])) * (-L_45[7]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-((-(P_c[18] * b_5[3])) * (-L_45[10]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) # e1 ^ e0
	x5[10] = (-((P_c[1] * b_5[2] + (-(P_c[2] * b_5[1]))) * (-L_45[7]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (P_c[1] * b_5[3] + (-(P_c[3] * b_5[1]))) * (-L_45[6]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-(P_c[5] * b_5[2])) * (-L_45[13]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((-(P_c[5] * b_5[3])) * (-L_45[11]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[18] * b_5[3])) * (-L_45[8]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) # e2 ^ e3
	x5[11] = (-((P_c[1] * b_5[2] + (-(P_c[2] * b_5[1]))) * (-L_45[8]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[4] * b_5[1])) * (-L_45[6]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (P_c[2] * b_5[3] + (-(P_c[3] * b_5[2]))) * (-L_45[13]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((-(P_c[4] * b_5[3])) * (-L_45[10]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[17] * b_5[3])) * (-L_45[7]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) # e2 ^ einf
	x5[12] = (-(P_c[5] * b_5[1])) * (-L_45[6]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((-(P_c[5] * b_5[3])) * (-L_45[10]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[18] * b_5[3])) * (-L_45[7]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) # e2 ^ e0
	x5[13] = (-((P_c[1] * b_5[3] + (-(P_c[3] * b_5[1]))) * (-L_45[8]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[4] * b_5[1])) * (-L_45[7]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((P_c[2] * b_5[3] + (-(P_c[3] * b_5[2]))) * (-L_45[11]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[4] * b_5[2])) * (-L_45[10]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((-(P_c[17] * b_5[3])) * (-L_45[6]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) # e3 ^ einf
	x5[14] = (-(P_c[5] * b_5[1])) * (-L_45[7]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-(P_c[5] * b_5[2])) * (-L_45[10]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((-(P_c[18] * b_5[3])) * (-L_45[6]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) # e3 ^ e0
	x5[15] = (-(P_c[5] * b_5[1])) * (-L_45[8]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-(P_c[5] * b_5[2])) * (-L_45[11]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-(P_c[5] * b_5[3])) * (-L_45[13]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) # einf ^ e0
	x5[26] = (P_c[1] * b_5[2] + (-(P_c[2] * b_5[1]))) * (-L_45[13]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((P_c[1] * b_5[3] + (-(P_c[3] * b_5[1]))) * (-L_45[11]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[4] * b_5[1])) * (-L_45[10]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (P_c[2] * b_5[3] + (-(P_c[3] * b_5[2]))) * (-L_45[8]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((-(P_c[4] * b_5[2])) * (-L_45[7]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[4] * b_5[3])) * (-L_45[6]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) # e1 ^ (e2 ^ (e3 ^ einf))
	x5[27] = (-(P_c[5] * b_5[1])) * (-L_45[10]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((-(P_c[5] * b_5[2])) * (-L_45[7]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[5] * b_5[3])) * (-L_45[6]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) # e1 ^ (e2 ^ (e3 ^ e0))
	x5[28] = (-(P_c[5] * b_5[1])) * (-L_45[11]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((-(P_c[5] * b_5[2])) * (-L_45[8]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[18] * b_5[3])) * (-L_45[13]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) # e1 ^ (e2 ^ (einf ^ e0))
	x5[29] = (-(P_c[5] * b_5[1])) * (-L_45[13]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((-(P_c[5] * b_5[3])) * (-L_45[8]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-((-(P_c[18] * b_5[3])) * (-L_45[11]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) # e1 ^ (e3 ^ (einf ^ e0))
	x5[30] = (-(P_c[5] * b_5[2])) * (-L_45[13]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) + (-((-(P_c[5] * b_5[3])) * (-L_45[11]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))))) + (-(P_c[18] * b_5[3])) * (-L_45[8]) / ((-(L_45[6] * (-L_45[6]))) + (-(L_45[7] * (-L_45[7]))) + (-(L_45[10] * (-L_45[10])))) # e2 ^ (e3 ^ (einf ^ e0))
	y5 = np.zeros(32)
	y5[0] = P_c[1] * b_5[1] + P_c[2] * b_5[2] + P_c[3] * b_5[3] # 1.0
	y5[6] = P_c[16] * b_5[3] # e1 ^ e2
	y5[7] = (-(P_c[16] * b_5[2])) # e1 ^ e3
	y5[8] = (-(P_c[17] * b_5[2])) # e1 ^ einf
	y5[9] = (-(P_c[18] * b_5[2])) # e1 ^ e0
	y5[10] = P_c[16] * b_5[1] # e2 ^ e3
	y5[11] = P_c[17] * b_5[1] # e2 ^ einf
	y5[12] = P_c[18] * b_5[1] # e2 ^ e0
	a_6 = np.zeros(32)
	a_6[1] = (-L_45[10]) # e1
	a_6[3] = (-L_45[6]) # e3
	b_6 = np.zeros(32)
	...
	b_6[3] = (-se_3) # e3
	x6 = np.zeros(32)
	x6[0] = a_6[1] * b_6[2] + (-(L_45[7] * b_6[1])) # 1.0
	x6[7] = L_45[7] * b_6[3] + (-(a_6[3] * b_6[2])) # e1 ^ e3
	x6[10] = (-(a_6[1] * b_6[3] + (-(a_6[3] * b_6[1])))) # e2 ^ e3
	y6 = np.zeros(32)
	y6[0] = a_6[1] * b_6[1] + L_45[7] * b_6[2] + a_6[3] * b_6[3] # 1.0
